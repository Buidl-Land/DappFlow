...
const TaskDetailsClient = ({ id }: { id: string }) => {
            ...
            <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
              <div>
                <div className="flex flex-wrap gap-2 mb-2">
                  ...
                  <span
                    className={`badge ${task.status === "open" ? "badge-secondary" : task.status === "in_progress" ? "badge-accent" : "badge-success"}`}
                  >
                    {task.status.replace("_", " ")}
                  </span>
                  <span className={`badge ${getDifficultyBadgeClass(difficulty)}`}>{difficulty}</span>
                </div>
              ...
              <div className="card-body p-0">
                ...
                <div className="p-4">
                  <div className="prose max-w-none">
                    ...
                    <p>
                      As part of the Wildlife Conservation Token (WCT) project, this task involves developing and
                      auditing smart contracts that will handle the automated distribution of donations to conservation
                      organizations. The smart contracts should:
                    </p>
                    ...
                    <p className="mt-4">
                      The completed smart contracts will be a critical component of the WCT ecosystem, enabling
                      transparent and efficient distribution of funds to wildlife conservation efforts in Africa.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="card-body p-0">
                ...
                <div className="p-4">
                  <button
                    ...
                    onClick={handleApply}
                    disabled={isMining || isApplying || !address}
                  >
                    {isMining || isApplying ? (
                      <>
